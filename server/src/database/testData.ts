...
async function loadTestData() {
    ...
    let challenges: Challenge[] = await save([
        new Challenge({ round: rounds[0], docker: '', previous: -1, tag: tags[0], type: ChallengeType.BASIC, name: 'bruhrurh', description: 'it begin herere!!\nare you excite?? epic cool? ye yes\n\njust watch out it wil be hard', points: 5, flag: 'FLAG 1', attachment: '', order: 1 }),
        new Challenge({ round: rounds[0], docker: '', previous: -1, tag: null, type: ChallengeType.BASIC, name: 'come have fun here! (', description: 'hoo good job!\n...\n\n         more coming :)', points: 5, flag: 'FLAG SECOND', attachment: '', order: 4 }),
        new Challenge({ round: rounds[1], docker: '', previous: -1, tag: null, type: ChallengeType.BASIC, name: 'contitnitueing!', description: 'haha yes hope you liked your break becuas eits babaout to get WILD!  CRAZY!', points: 10, flag: 'cool flag B)', attachment: '', order: 4 }),
        new Challenge({ round: rounds[1], docker: '', previous: -1, tag: tags[0], type: ChallengeType.BASIC, name: 'thius is onlyly the begine', description: 'harder and harder it will get yeees', points: 15, flag: 'mmmmMMMMMMMMMMMMMMMMMMMMMM!', attachment: '', order: 3 }),
        new Challenge({ round: rounds[1], docker: '', previous: -1, tag: null, type: ChallengeType.BASIC, name: 'warm up cuz abotu to get stemey', description: 'i was just joking this one dont even got points LMAO\n\n\n\n\n\nepic owned', points: 0, flag: 'usesless flag LOL', attachment: '', order: 1 }),
        new Challenge({ round: rounds[1], docker: '', previous: -1, tag: tags[1], type: ChallengeType.BASIC, name: 'haha finif', description: 'BOO! yeah now it s hard cunt watch out ccd', points: 20, flag: 'haha you wont even find this i bet', attachment: '', order: 7 }),
        new Challenge({ round: rounds[2], docker: '', previous: -1, tag: tags[2], type: ChallengeType.BASIC, name: 'huhgg FIN#', description: 'Quest-ce que Lorem Ipsum? Lorem Ipsum est simplement un faux texte de lindustrie de limpression et de la composition. Lorem Ipsum a été le texte factice standard de lindustrie depuis les années 1500, quand un imprimeur inconnu a pris une galère de caractères et la brouillée pour en faire un livre de spécimens. Il a survécu non seulement cinq siècles, mais aussi le saut dans la composition électronique, demeurant essentiellement inchangé. Il a été popularisé dans les années 1960 avec la sortie de feuilles Letraset contenant des passages du Lorem Ipsum, et plus récemment avec un logiciel de publication assistée par ordinateur comme Aldus PageMaker comprenant des versions de Lorem Ipsum.', points: 999, flag: 'tres bon', attachment: '', order: 2 })
    ]);
